 ...
 */
	public function testGetTemplate() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Posts' . DS . 'tanks_setup.ctp';
 ...
 */
	public function testPluginGetTemplate() {
		...
		$expected = CakePlugin::path('TestPlugin') . 'View' . DS . 'Tests' . DS . 'tanks_setup.ctp';
 ...
 */
	public function testPluginThemedGetTemplate() {
		...
		$ThemeView = new TestThemeView($this->Controller);
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Themed' . DS . 'TestTheme' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'Tests' . DS . 'tanks_setup.ctp';
 ...
 */
	public function testCamelCasePluginGetTemplate() {
		...
		$pluginPath = CakePlugin::path('TestPlugin');
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'Plugin' . DS . 'TestPlugin' . DS . 'View' . DS . 'Tests' . DS . 'tanks_setup.ctp';
		$result = $View->getViewFileName('index');
		$this->assertEquals($expected, $result);
 ...
 */
	public function testGetViewFileNames() {
		...
		$expected = CAKE . 'Test' . DS . 'test_app' . DS . 'View' . DS . 'Posts' . DS . 'tanks_setup.ctp';
 ...
 */
	public function testViewFileName() {
		...
		$result = $View->getViewFileName('index');
		$this->assertRegExp('/Posts(\/|\\\)tanks_setup.ctp/', $result);
		...
		$this->assertRegExp('/Themed(\/|\\\)TestTheme(\/|\\\)Posts(\/|\\\)tanks_setup.ctp/', $result);
