var WayBill = {
    ...
    init:function () {
        ...
        columns.push({display:'BDC Approval', name:'bdc_id', width:230, sortable:false, align:'center', hide:false});
        ...
        btn_actions.push({type:'select',name: 'Filter BDC', id: 'filter_bdc' ,bclass: 'filter',onchange:self.handleGridEvent,options:bdc_filter});
        btn_actions.push({separator:true});
   ...
   handleGridEvent:function (com, grid, json) {
        ...
        else if (com == 'Filter BDC' || com == 'Status') {
