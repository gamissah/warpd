...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'Ceps', 'action' => 'waybills/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'Ceps', 'action' => 'waybills/save')); ?>" />
<input type="hidden" id="table-details-url" value="<?php echo $this->Html->url(array('controller' => 'Ceps', 'action' => 'waybills/load_details')); ?>" />

<input type="hidden" id="grid_load_url" value="<?php echo $this->Html->url(array('controller' => 'Ceps', 'action' => 'waybills/load')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'Ceps', 'action' => 'waybills/delete')); ?>" />
<input type="hidden" id="print_waybill_url" value="<?php echo $this->Html->url(array('controller' => 'Ceps', 'action' => 'print_waybill')); ?>" />
...
<!-- Le Script -->
<?php
echo $this->Html->script('scripts/ceps/waybill.js');
?>
