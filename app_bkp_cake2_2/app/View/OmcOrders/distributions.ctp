            ...
            <div class="span3">
                ...
                <div class="block-fluid">
                    <div class="row-form clearfix" style="border-top-width: 0px; padding: 5px 16px;">
                        ...
                        <div class="span5">
                            <?php /*echo $this->Form->input('export_startdt', array('id'=>'export_startdt', 'class' => 'span2 date-masking validate[required] datepicker','default'=>date('d-m-Y'),'placeholder'=>'dd-mm-yyyy', 'div' => false, 'label' => false,)); */?>
                    ...
                    <div class="row-form clearfix" style="border-top-width: 0px; padding: 3px 16px;">
                        ...
                        <div class="span5">
                            <?php /*echo $this->Form->input('export_enddt', array('id'=>'export_enddt', 'class' => 'span2 date-masking validate[required] datepicker','default'=>date('d-m-Y'),'placeholder'=>'dd-mm-yyyy', 'div' => false, 'label' => false,)); */?>
