...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Monthly Loading By BDCs <small>Report</small></h1>
    </div>
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'OmcReporting', 'action' => 'print_export_bdc_variant')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/report_omc_monthly_bdc_variant.js');
    if(in_array('PX',$permissions)){
