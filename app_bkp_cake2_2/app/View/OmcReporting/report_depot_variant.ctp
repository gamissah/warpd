...
<div class="workplace">
                                ...
                                tooltip: {
                                   // pointFormat: '{series.name}: <b>{point.y} ltrs {jLib.formatNumber(point.y,'money',1)}%</b>',
                                    ...
                                    formatter: function(series) {
                                        return ''+this.series.name +':   <b>'+ jLib.formatNumber(this.point.y,'number',0) +' ltrs '+ jLib.formatNumber(this.point.percentage,'money',1) +'%';
                                    }
                                },
                                plotOptions: {
                                    pie: {
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'OmcReporting', 'action' => 'print_export_depot_variant')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/report_omc_monthly_depot_variant.js');
    if(in_array('PX',$permissions)){
