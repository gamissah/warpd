<div class="workplace">
    ...
    <div class="page-header">
        <h1>Upload UPPF Distances <small> </small></h1>
    </div>
            ...
            <fieldset>
                ...
                <fieldset>
                    ...
                    <div class="form-actions" style="padding-left: 10px;">
                        <button type="submit" class="btn btn-primary" id="upload-btn">Upload Distances </button>
                ...
                if($mesg){
                    ...
                    <div id="loginmsg" style="">
                        <?php
                        // if($error){
                        echo $this->Message->msg('Distance Upload',$mesg,'warning',true);
                        /* }
                         else{
