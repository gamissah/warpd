<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Order Delivery <small> Dashboard</small></h1>
    </div>
...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'orders_delivery/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'orders_delivery/save')); ?>" />
<input type="hidden" id="table-details-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'orders_delivery/load_details')); ?>" />

<input type="hidden" id="grid_load_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'orders_delivery/load')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'orders_delivery/delete')); ?>" />
...
<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc_customer/delivery_order.js');
?>
