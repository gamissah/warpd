...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Customers Bio Data <small> Dashboard</small></h1>
    </div>
    ...
    <div class="row-fluid">
        ...
        <div class="span12">
            ...
            <div class="head clearfix">
                ...
                <h1>Customers Bio Data Table</h1>
            </div>
...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomers', 'action' => 'customers/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomers', 'action' => 'customers/save')); ?>" />
<input type="hidden" id="table-details-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomers', 'action' => 'customers/load_details')); ?>" />

<input type="hidden" id="grid_load_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomers', 'action' => 'customers/load')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomers', 'action' => 'customers/delete')); ?>" />
<input type="hidden" id="export_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomers', 'action' => 'export_customers')); ?>" />



<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc_customers.js');
?>
