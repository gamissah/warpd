...
<div class="workplace">
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'BdcReporting', 'action' => 'print_export_monthly_distributions')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/report_monthly_distributions.js');
    if(in_array('PX',$permissions)){
