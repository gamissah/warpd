...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Monthly Loading By OMCs <small>Report</small></h1>
    </div>
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'BdcReporting', 'action' => 'print_export_omc_variant')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/report_monthly_omc_variant.js');
    if(in_array('PX',$permissions)){
