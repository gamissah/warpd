...
<!-- Users URL -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'Messages', 'action' => 'address_book/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'Messages', 'action' => 'address_book/save')); ?>" />
<input type="hidden" id="table-delete-url" value="<?php echo $this->Html->url(array('controller' => 'Messages', 'action' => 'address_book/delete')); ?>" />


<?php
    echo $this->Html->script('scripts/mail_address_book.js');
?>
