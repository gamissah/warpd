        ...
        <div class="span3">
            ...
            <div class="block-fluid">
                ...
                <div class="footer tal">
                    ...
                    <?php /*echo $this->Form->input('export_url', array('type'=>'hidden','id'=>'export_url', 'value'=> $this->Html->url(array('controller' => 'OmcCustomerOrders', 'action' => 'export_orders')))); */?>
...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerStock', 'action' => 'tanks_setup/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerStock', 'action' => 'tanks_setup/save')); ?>" />
<input type="hidden" id="table-details-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerStock', 'action' => 'tanks_setup/load_details')); ?>" />

<input type="hidden" id="grid_load_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerStock', 'action' => 'tanks_setup/load')); ?>" />
<input type="hidden" id="grid_delete_url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerStock', 'action' => 'tanks_setup/delete')); ?>" />


<!-- Le Script -->
<?php
echo $this->Html->script('scripts/omc_customer/tanks.js');
?>
