    ...
    <div class="row-fluid">
        <div class="span6">
            <div class="profile clearfix">
                ...
                <div class="info">
                    <p><span class="icon-globe"></span> <span class="title">Address:</span>  <?php echo $bdc['Bdc']['address']; ?></p>
                    <p><span class="icon-gift"></span> <span class="title">Date of Registration:</span> <?php echo date("d M Y, g:ia", strtotime($bdc['Bdc']['created'])); ?></p>
                </div>
        ...
        <div class="span6">
            ...
            <div class="block-fluid">
                <?php echo $this->Form->create('Bdc', array('id' => 'form-bdc','class'=>'form-horizontal'));?>
                <div class="row-form clearfix" style="border-top-width: 0px;">
                    <div class="span3">Name:</div>
                    <div class="span9">
                        <?php echo $this->Form->input('name', array('id'=>'name', 'value'=>$bdc['Bdc']['name'],'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('city', array('id'=>'city', 'value'=>$bdc['Bdc']['city'],'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('location', array('id'=>'location', 'value'=>$bdc['Bdc']['location'],'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('address', array('id'=>'address', 'value'=>$bdc['Bdc']['address'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('postal_code', array('id'=>'postal_code', 'value'=>$bdc['Bdc']['postal_code'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('telephone', array('id'=>'telephone', 'value'=>$bdc['Bdc']['telephone'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('country', array('id'=>'country', 'value'=>$bdc['Bdc']['country'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="footer tal">
                    ...
                    ?>
                    <?php echo $this->Form->input('id', array('type'=>'hidden','id'=>'id', 'value'=>$bdc['Bdc']['id'], 'div' => false, 'label' => false)); ?>
                </div>
...
<!-- URLs -->
<input type="hidden" id="company_save_url" value="<?php echo $this->Html->url(array('controller' => 'BdcAdmin', 'action' => 'company')); ?>" />
