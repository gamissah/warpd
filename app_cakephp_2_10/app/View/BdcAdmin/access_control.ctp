<div class="workplace">
    ...
    <div class="page-header">
        <h1><?php echo $company_profile['name']; ?> <small> Access Control</small></h1>
    </div>
...
<!-- URLs -->
<input type="hidden" id="access_control_url" value="<?php echo $this->Html->url(array('controller' => 'BdcAdmin', 'action' => 'access_control')); ?>" />
