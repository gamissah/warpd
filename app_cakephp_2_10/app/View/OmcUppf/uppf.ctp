<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">UPPF <small>Report</small></h1>
    </div>
        ...
        <div class="span12">
            ...
            <div class="block-fluid">
                <div class="row-form clearfix" style="border-top-width: 0px; padding: 5px 16px;">
                    ...
                    <div class="span2">
                        <?php echo $this->Form->input('start_dt', array('id'=>'start_dt', 'class' => 'span2 date-masking validate[required] datepicker','default'=>$start_dt,'placeholder'=>'dd-mm-yyyy', 'div' => false, 'label' => false,)); ?>
                    </div>

                    <div class="span2" style="width: 80px;">End Date:</div>
                    <div class="span2">
                        <?php echo $this->Form->input('end_dt', array('id'=>'end_dt', 'class' => 'span2 date-masking validate[required] datepicker','default'=>$end_dt,'placeholder'=>'dd-mm-yyyy', 'div' => false, 'label' => false,)); ?>
                    </div>
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'OmcUppf', 'action' => 'print_export_uppf')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/uppf.js');
