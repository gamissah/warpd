...
<div class="workplace">
    ...
    <div class="page-header">
        <h1>Bulk Stock Position : <?php echo date('l jS F Y');?> <small> </small></h1>
    </div>
                        ...
                        <?php
                            if($form_data){
                                foreach($form_data as $row){
                                    $row_id = $row['OmcBulkStockPosition']['id'];
                                    ?>
                                    <tr data-id="<?php echo $row_id ;?>">
                                        ...
                                        foreach($table_setup as $tr_row){
                                            ...
                                            $cell_value = $field_value = $row['OmcBulkStockPosition'][$field];
...
<!-- URLs -->
<input type="hidden" id="form-save-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'bulk_stock_position')); ?>" />
...
<?php
    ...
    echo $this->Html->script('scripts/omc_customer/bulk_stock_position.js');
?>
