...
<div class="workplace">
    ...
    <div class="page-header">
        <h1>Lubricants Position : <?php echo date('l jS F Y');?> <small> </small></h1>
    </div>
                                ...
                                foreach($form_data as $row){
                                    ...
                                    <tr data-id="<?php echo $row_id ;?>">
                                        ...
                                        foreach($table_setup as $tr_row){
                                            ...
                                            $cell_value = $field_value = $row['OmcLube'][$field];
...
<!-- URLs -->
<input type="hidden" id="form-save-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'lubricants')); ?>" />
