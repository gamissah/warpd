...
<div class="workplace">
    ...
    <div class="page-header">
        <h1>Cash & Credit Summary Cumulative : <?php echo date('l jS F Y');?> <small> </small></h1>
    </div>
                    ...
                    <tbody>
                        <?php
                            ...
                            foreach($table_setup as $row){
                                ...
                                $row_id = $id;
                                $cell_value = $field_value = $form_data['OmcCashCreditSummary'][$field];
...
<!-- URLs -->
<input type="hidden" id="form-save-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'cash_credit_summary')); ?>" />
...
<?php
    ...
    echo $this->Html->script('scripts/omc_customer/cash_credit_summary.js');
?>
