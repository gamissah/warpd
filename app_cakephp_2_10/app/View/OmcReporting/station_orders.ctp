...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Station Orders <small>Report</small></h1>
    </div>
        ...
        <div class="span4">
            ...
            <div class="block-fluid">
                ...
                <div class="row-form clearfix" style="border-top-width: 0px; padding: 3px 16px;">
                    ...
                    <div class="span5">
                        <?php echo $this->Form->input('omc_customer', array('id'=>'omc_customer', 'class' => '','default'=>$default_omc_customer,'options'=>$omc_customer_lists, 'div' => false, 'label' => false,)); ?>
                    </div>
                </div>
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'OmcReporting', 'action' => 'print_export_station_orders')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/omc/station_orders.js');
    if(in_array('PX',$permissions)){
