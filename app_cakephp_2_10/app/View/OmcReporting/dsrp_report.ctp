...
<?php //debug($authUser); ?>
        ...
        <div class="span12">
            ...
            <div class="block-fluid">
                <div class="row-form clearfix" style="border-top-width: 0px; padding: 5px 16px;">
                    ...
                    <div class="span2">
                        <?php echo $this->Form->input('customer', array('id'=>'customer', 'class' => '','default'=>$default_customer,'options'=>$customer_list, 'div' => false, 'label' => false,)); ?>
                    </div>
                </div>

                <div class="footer tal">
                    <button class="btn" type="submit" id="query-btn">Get Report </button>
                    <button class="btn btn-info" type="button" id="view_station_dashboard">View Station Dashboard </button>
                </div>
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'OmcReporting', 'action' => 'export_dsrp')); ?>" target="PrintExportWindow">
...
<input type="hidden" id="station_dashboard_url" value="<?php echo $this->Html->url(array('controller' => 'OmcReporting', 'action' => 'view_station_dashboard')); ?>" />
