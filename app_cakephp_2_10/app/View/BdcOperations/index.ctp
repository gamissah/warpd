    ...
    <div class="row-fluid">
                    ...
                    $(function () {
                        $(document).ready(function() {
                            var options_bar = {
                                ...
                                /*subtitle: {
                                    text: "<a onclick='alert(2)'>Enlarge</a>",
                                    x: -20
                                },*/
                                xAxis: {
                                    categories: days
        ...
        <div class="span4">
            <div class="head clearfix">
                ...
                <h1>Today's Loaded Order (ltrs)</h1>
                <ul class="buttons">
                    ...
                    ?>
                        <div class="item clearfix">
                            ...
                            <div class="info">
                                ...
                                <!--<span></span>-->
                                <div class="controls">
                                    <?php echo $this->App->formatNumber($pl['qty'],'money',0) ;?>
                                </div>
                                <!--<div class="controls">
...
<script type="text/javascript">
    $(document).ready(function() {
        $('.table_responsive').responsiveTable({staticColumns: 2, scrollRight: false, scrollHintEnabled: false} );
    });
</script>
