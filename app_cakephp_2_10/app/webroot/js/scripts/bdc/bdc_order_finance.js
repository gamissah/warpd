var BdcOrder = {
    ...
    init:function () {
        ...
        columns.push({display:'Finance Approval', name:'finance_approval', width:140, sortable:true, align:'center', hide:false, editable:{form:'select', validate:'', defval:'', options:fna_feedback}});
        columns.push({display:'Approved Quantity', name:'approved_quantity', width:120, sortable:true, align:'center', hide:false, editable:{form:'select', validate:'empty,moneyNumber', bclass:'quantity-class', defval:'',options:volumes}});
