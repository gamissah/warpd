       ...
       // btn_actions.push({type:'select',name: 'Order Status', id: 'filter_status',bclass: 'filter',onchange:self.handleGridEvent,options:order_filter});
        ...
        self.objGrid = $('#flex').flexigrid({
            ...
            colModel:[
                ...
                {display:'Order Date', name:'order_date', width:100, sortable:false, align:'left', hide:false, editable:{form:'text', validate:'empty', placeholder:'dd-mm-yyyy',bclass:'datepicker', maxlength:'10', defval:jLib.getTodaysDate('mysql_flip')}},
                ...
                {display:'Order Quantity', name:'order_quantity', width:100, sortable:true, align:'left', hide:false, editable:{form:'select', validate:'empty,numeric',bclass:'quantity-class',defval:'',options:volumes}},
                {display:'Intended Delivery Location', name:'intended_delivery_location', width:170, sortable:true, align:'left', hide:false, editable:{form:'text', validate:'', defval:''}},
                {display:'OMC Feedback', name:'omc_feedback', width:160, sortable:true, align:'left', hide:false}
