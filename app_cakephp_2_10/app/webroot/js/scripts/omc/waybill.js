var WayBill = {
    ...
    init:function () {
        ...
        columns.push({display:'Depot', name:'depot_id', width:130, sortable:false, align:'center', hide:false});
        columns.push({display:'BDC', name:'bdc_id', width:230, sortable:false, align:'center', hide:false});
        columns.push({display:'CEPS', name:'cep_id', width:230, sortable:true, align:'center', hide:false});
...
/*
   ...
   handleGridEvent:function (com, grid, json) {
        ...
        else if (com == 'Filter OMC' || com == 'Status') {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (response.code == 0) {
                            ...
                            //jLib.message('Waybill Approval',txt, 'success');
                        }
                        else {
