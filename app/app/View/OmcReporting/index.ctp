...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Monthly Product Loading <small>Report</small></h1>
    </div>
        ...
        <div class="span4">
            ...
            <div class="block-fluid">
                ...
                <!--<div class="row-form clearfix" style="border-top-width: 0px; padding: 3px 16px;">
                    ...
                    <div class="span5">
                        <?php /*echo $this->Form->input('omc', array('id'=>'omc', 'class' => '','default'=>$default_omc,'options'=>$omclists, 'div' => false, 'label' => false,)); */?>
                    </div>
                </div>-->
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'OmcReporting', 'action' => 'print_export_monthly_distributions')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/report_omc_monthly_distributions.js');
    if(in_array('PX',$permissions)){
