...
<!-- URLs -->
<input type="hidden" id="table-url" value="<?php echo $this->Html->url(array('controller' => 'NpaAdmin', 'action' => 'users/get')); ?>" />
<input type="hidden" id="table-editable-url" value="<?php echo $this->Html->url(array('controller' => 'NpaAdmin', 'action' => 'users/save')); ?>" />
<input type="hidden" id="load_url" value="<?php echo $this->Html->url(array('controller' => 'NpaAdmin', 'action' => 'users/load')); ?>" />
<input type="hidden" id="delete_url" value="<?php echo $this->Html->url(array('controller' => 'NpaAdmin', 'action' => 'users/delete')); ?>" />


<!-- Le Script -->
<?php
echo $this->Html->script('scripts/npa_users.js');
?>
