...
<div class="workplace">
    ...
    <div class="page-header">
        <h1 style="font-size: 30px;">Customer Orders <small>Report</small></h1>
    </div>
    ...
    <div class="row-fluid">
                    ...
                    <tr>
                        ...
                        foreach($tbd_arr as $key => $v){
                            ...
                            <?php
                                ...
                                ?>
                                <td><?php echo $this->App->formatNumber($v,'money',0).'' ;?></td>
                            <?php
                            }
                        }
                        ?>
        ...
        <div class="span4">
            ...
            <div class="block-fluid">
                ...
                <div class="row-form clearfix" style="border-top-width: 0px; padding: 3px 16px;">
                    <div class="span5">OMCs:</div>
                    <div class="span5">
                        <?php echo $this->Form->input('omc', array('id'=>'omc', 'class' => '','default'=>$default_omc,'options'=>$omc_lists, 'div' => false, 'label' => false,)); ?>
                    </div>
                </div>
                ...
                <div class="footer tal">
                    ...
                    <?php echo $this->Form->input('omc_name', array('type'=>'hidden','id'=>'omc_name', 'value'=>'' )); ?>
                </div>
    ...
    <form id="print-export-form" method="post" action="<?php echo $this->Html->url(array('controller' => 'BdcReporting', 'action' => 'print_export_orders')); ?>" target="PrintExportWindow">
...
<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/report_orders.js');
    if(in_array('PX',$permissions)){
