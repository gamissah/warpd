<div class="menu">
    ...
    <ul class="navigation">
        <li class="<?php echo ($this->params['action'] == 'dashboard' && $this->params['controller'] == 'Depot')? 'active': '' ;?>">
            <a href="<?php echo $this->Html->url(array('controller' =>  'Depot', 'action' =>  'dashboard')); ?>">
