...
<div class="workplace">
    ...
    <div class="page-header">
        <h1>Operator's Credit Situation : <?php echo date('l jS F Y');?> <small> </small></h1>
    </div>
        ...
        <div class="span12">
            ...
            <div class="block-fluid">
                ...
                <table id="" class="form-table table table-bordered">
                    ...
                    <tbody>
                        <?php
                            $id = $form_data['OmcOperatorsCredit']['id'];
                            foreach($table_setup as $row){
                                $header = $row['header'];
                                $field = $row['field'];
                                $format = $row['format'];
                                ...
                                $row_id = $id;
                                $cell_value = $field_value = $form_data['OmcOperatorsCredit'][$field];
...
<!-- URLs -->
<input type="hidden" id="form-save-url" value="<?php echo $this->Html->url(array('controller' => 'OmcCustomerDailySales', 'action' => 'operators_credit')); ?>" />
...
<?php
    ...
    echo $this->Html->script('scripts/omc_customer/operators_credit.js');
?>
