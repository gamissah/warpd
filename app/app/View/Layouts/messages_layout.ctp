    ...
    <body>
        <div class="wrapper">
            ...
            <?php
                ...
                if($user_type == 'bdc'){
                    echo $this->element('menu_bdc');
                }
                elseif($user_type == 'omc'){
                    echo $this->element('menu_omc');
                }
                elseif($user_type == 'omc_customer'){
                    echo $this->element('menu_omc_customer');
                }
                elseif($user_type == 'ceps_central' || $user_type == 'ceps_depot'){
                    echo $this->element('menu_ceps');
                }
                elseif($user_type == 'depot'){
                    echo $this->element('menu_depot');
                }
                else{
                    if($company_profile['comp_type'] == 'npa'){
                        echo $this->element('menu_npa');
                    }
                }
            ?>
            <div class="content">
