...
<head>
   ...
   // echo $this->Html->css('developr-colors');
    echo $this->Html->css('developr-notify');
    echo $this->Html->css('progress-slider');
    ...
    echo $this->Html->script('plugins/jquery.autocomplete.min.js');
    ...
    echo $this->Html->script('plugins/jquery.fixedheadertable.min.js');
    ...
    echo $this->Html->script('alertify/src/alertify.js');
    echo $this->Html->script('tagsinput/jquery.tagsinput.min.js');
    ...
    <body>
        <div class="wrapper">
            ...
            <?php echo $this->element('menu_omc'); ?>
            <div class="content">
