    ...
    <div class="row-fluid">
        <div class="span6">
            <div class="profile clearfix">
                ...
                <div class="info">
                    <p><span class="icon-globe"></span> <span class="title">Address:</span>  <?php echo $org['Depot']['address']; ?></p>
                    <p><span class="icon-gift"></span> <span class="title">Date of Registration:</span> <?php echo date("d M Y, g:ia", strtotime($org['Depot']['created'])); ?></p>
                </div>
        ...
        <div class="span6">
            ...
            <div class="block-fluid">
                ...
                <div class="row-form clearfix" style="border-top-width: 0px;">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('name', array('id'=>'name', 'value'=>$org['Depot']['name'],'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('city', array('id'=>'city', 'value'=>$org['Depot']['city'],'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('location', array('id'=>'location', 'value'=>$org['Depot']['location'],'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('address', array('id'=>'address', 'value'=>$org['Depot']['address'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('postal_code', array('id'=>'postal_code', 'value'=>$org['Depot']['postal_code'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('telephone', array('id'=>'telephone', 'value'=>$org['Depot']['telephone'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="row-form clearfix">
                    ...
                    <div class="span9">
                        <?php echo $this->Form->input('country', array('id'=>'country', 'value'=>$org['Depot']['country'], 'div' => false, 'label' => false)); ?>
                    </div>
                </div>
                ...
                <div class="footer tal">
                    ...
                    ?>
                    <?php echo $this->Form->input('id', array('type'=>'hidden','id'=>'id', 'value'=>$org['Depot']['id'], 'div' => false, 'label' => false)); ?>
                </div>
...
<!-- URLs -->
<input type="hidden" id="company_save_url" value="<?php echo $this->Html->url(array('controller' => 'DepotAdmin', 'action' => 'company')); ?>" />

<!-- Le Script -->
<?php
    echo $this->Html->script('scripts/depot_company.js');
?>
